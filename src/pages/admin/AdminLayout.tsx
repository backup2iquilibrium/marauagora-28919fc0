import { Newspaper, Tag, Users, Megaphone, FileText, Settings, MapPin, Briefcase, CalendarDays, Info, Shield } from "lucide-react";
...
const navItems: DashboardNavItem[] = [
  ...
  { to: "/admin/guia-da-cidade", label: "Guia da Cidade", icon: MapPin },
  ...
  { to: "/admin/policia", label: "Polícia & Úteis", icon: Shield },
